...
ssize_t solve_equation(const struct Coefficients* const coef_pointer, double* const solutions_array) /// solves equatation ax^2 + bx + c = 0
{
    ssize_t num_of_solutions = INVALID_NUMBER;
...
ssize_t solve_linear(const struct Coefficients* coef_pointer, double* const solutions_array) /// solves equatation bx + c = 0
{
    ssize_t num_of_solutions = INVALID_NUMBER;
...
ssize_t solve_quadratic(const struct Coefficients* const coef_pointer, double* const solutions_array) ///solves equatation ax^2 + bx + c = 0 (a != 0)
{
    ssize_t num_of_solutions = INVALID_NUMBER;
